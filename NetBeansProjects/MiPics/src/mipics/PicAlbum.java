 ...
 * @author Andrew
 */
public class PicAlbum extends JFrame implements TreeSelectionListener {
...
private DefaultMutableTreeNode getTagTree (){
    ...
    public void addTag() {
        if (file == null)
        {
            JOptionPane.showMessageDialog(PicAlbum.this, "Please open a photo to tag first","Error", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
...
Then iterate over treePaths and invoke removeSelectionPath to deselect the nodes
    for (TreePath treePath : treePaths) {
       ...
       // }
        ...
        {
            JOptionPane.showMessageDialog(PicAlbum.this, "Please enter a Tag","Error", JOptionPane.INFORMATION_MESSAGE);
   ...
   */}
   private void changeTag(){
       ...
       if (selectedNode == null){
           JOptionPane.showMessageDialog(PicAlbum.this, "Select a Tag to Change", "Error", JOptionPane.ERROR_MESSAGE);
       }
       else { String newName = JOptionPane.showInputDialog(PicAlbum.this, "Enter a new tag name");
